...
document.getElementById('open-menu').addEventListener('click', () =>{
    ...
    document.getElementById('welcomeMsg-top-container').style.filter = 'blur(1.5px)';
    document.getElementById('aboutVisionMission-top-container').style.filter = 'blur(1.5px)';
    document.getElementById('top-service-container').style.filter = 'blur(1.5px)';
    document.getElementById('top-experience-container').style.filter = 'blur(1.5px)';
    document.getElementById('top-team-container').style.filter = 'blur(1.5px)';
    document.getElementById('top-contact-container').style.filter = 'blur(1.5px)';
    document.getElementById('footer-section').style.filter = 'blur(1.5px)';
});
